...
export default function AchievementsPage() {
  ...
  const studentAchievements = [
    {
      titleEn: 'Academic Excellence & Meritorious Performance',
    ...
    {
      titleEn: 'Clinical Skill & Practical Bedside Performance',
    ...
    {
      titleEn: 'Nursing Skill & Simulation Competitions',
    ...
    {
      titleEn: 'Quiz, Poster Presentation & Elocution',
    ...
    {
      titleEn: 'Seminars & Scientific Research Presentations',
    ...
    {
      titleEn: 'Sports & Cultural Fest Participations',
    ...
    {
      titleEn: 'Inter-Collegiate Competitions & Honors',
    ...
    {
      titleEn: 'Student Council Leadership & Governance',
  ...
  const communityActivities = [
    ...
    {
      titleEn: 'Pulse Polio & Universal Immunization Support',
    ...
    {
      titleEn: 'Mega Blood Donation Camps & Donor Directory',
    ...
    {
      titleEn: 'National Health Awareness Rallies & Street Plays',
  ...
  return (
    <main className="page-main">
      ...
      <section className="page-banner">
        <div className="container">
          <h1 className="banner-title">
            {isMr ? '🏆 उपलब्धी व विविध उपक्रम' : '🏆 Achievements & Activities'}
          </h1>
          <nav className="breadcrumb">
            <Link href="/">{isMr ? 'मुख्यपृष्ठ' : 'Home'}</Link> /{' '}
            <span>{isMr ? 'उपलब्धी व उपक्रम' : 'Achievements & Activities'}</span>
          </nav>
        </div>
      </section>
      ...
      <section className="page-content container section-padding" style={{ padding: '60px 0' }}>
        {/* Intro */}
        <div className="intro-text text-center" style={{ maxWidth: '860px', margin: '0 auto 50px' }}>
          ...
          <h2 className="section-title" style={{ fontSize: '2.3rem', color: '#0d3b66', margin: '0 0 16px' }}>
            {isMr
              ? 'उत्कृष्टतेचा गौरव • कौशल्याचा विकास • समाजसेवेची बांधिलकी'
              : 'Celebrating Excellence, Talent & Continuous Growth'}
          </h2>
        ...
        {/* ========================================================
            1. STUDENT ACHIEVEMENTS (विद्यार्थी उपलब्धी)
            ======================================================== */}
        ...
        {/* ========================================================
            2. COMMUNITY HEALTH & SOCIAL OUTREACH
            ======================================================== */}
        <div
          style={{
            backgroundColor: '#ffffff',
          ...
          >
            <div>
              <h3 style={{ color: '#ffffff', fontSize: '1.65rem', margin: '0 0 6px', display: 'flex', alignItems: 'center', gap: '10px' }}>
                ...
                {isMr ? 'सामाजिक आरोग्य उपक्रम व जनजागृती' : 'Community Health & Social Initiatives'}
              </h3>
        ...
        <div style={{ marginBottom: '50px' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px', flexWrap: 'wrap', gap: '10px' }}>
            ...
            <Link href="/gallery" className="btn btn-secondary" style={{ fontSize: '0.9rem', padding: '8px 18px' }}>
              {isMr ? 'संपूर्ण गॅलरी पहा' : 'View Full Gallery'} &nbsp;&rarr;
            </Link>
          </div>
        ...
        >
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '16px', flexWrap: 'wrap' }}>
            <Link href="/contact" className="btn btn-primary" style={{ backgroundColor: '#ffb703', color: '#0d3b66', fontWeight: '700' }}>
              <i className="fas fa-user-plus" style={{ marginRight: '8px' }}></i>
              {isMr ? 'प्रवेशासाठी संपर्क साधा' : 'Apply for Admission'}
            </Link>
            <Link href="/courses" className="btn btn-secondary" style={{ color: '#fff', borderColor: '#fff' }}>
              <i className="fas fa-book-reader" style={{ marginRight: '8px' }}></i>
