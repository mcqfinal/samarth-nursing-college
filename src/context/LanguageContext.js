...
export const translations = {
  en: {
    ...
    navCommittees: 'Committees & Cells',
    ...
    navSyllabus: 'Curriculum & Syllabus',
    navAdmission: 'Admission',
    navAdmissionProcess: 'Admission Process & Form',
    navAdmissionCriteria: 'Admission Criteria & Eligibility',
    navFeeStructure: 'Fees Structure & Scholarships',
    ...
    navQuestionPapers: 'Download Old Question Papers',
    ...
    aboutStatHostel: 'Hostel Facility',
    aboutStatHostelVal: 'Available',
  ...
  mr: {
    ...
    navCommittees: 'महाविद्यालयीन समित्या (Committees)',
    navAcademicCalendar: 'शैक्षणिक कॅलेंडर (Calendar)',
    ...
    navSyllabus: 'अभ्यासक्रम तपशील (Syllabus)',
    navAdmission: 'प्रवेश प्रक्रिया',
    navAdmissionProcess: 'प्रवेश प्रक्रिया व अर्ज',
    navAdmissionCriteria: 'प्रवेश निकष व पात्रता (Criteria)',
    navFeeStructure: 'फी रचना व सवलती (Fees Structure)',
    ...
    navQuestionPapers: 'मागील वर्षांचे प्रश्नसंच (Question Papers)',
    ...
    aboutStatFaculty: 'अनुभवी प्राध्यापक वर्ग',
